...
if (!JWT_SECRET) {
  // Fail loud in server logs — never fall back to a guessable secret.
  console.error('[auth] FATAL: JWT_SECRET is not set. Admin auth is disabled until it is configured.')
}
