// Shared seed data (CommonJS so it can be used by both the Prisma CLI seed
// script `prisma/seed.js` (node) and the runtime lazy seeder `lib/ensureSeed.js`).
// Data ONLY — no DB client here.
...
module.exports = { PACKAGES, TESTIMONIALS, GALLERY }
